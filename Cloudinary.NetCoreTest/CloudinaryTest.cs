...
namespace Cloudinary.NetCoreTest
{
    public class CloudinaryTest : IntegrationTestBase
    {
        ...
        protected IEnumerable<CloudinaryDotNet.Actions.Resource> GetAllResults(Func<String, ListResourcesResult> list)
        {
            ...
            IEnumerable<CloudinaryDotNet.Actions.Resource> resources = current.Resources;
        ...
        public void TestListResourcesByType()
        {
            ...
            IEnumerable<CloudinaryDotNet.Actions.Resource> result = GetAllResults((cursor) => m_cloudinary.ListResourcesByType("upload", cursor));
        ...
        public void TestListResourcesByPublicIds()
        {
            ...
            //var expected = new String[]{"testlistresources",
            //        "testlistblablabla",
            //        "test_context"};
        ...
        public void TestManualModeration()
        {
            ...
            var updateResult = m_cloudinary.UpdateResource(new UpdateParams(uploadResult.PublicId) { ModerationStatus = CloudinaryDotNet.Actions.ModerationStatus.Approved });
